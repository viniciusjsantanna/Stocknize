...
namespace Stocknize.Webapi.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<ProductOutputModel> Post([FromBody] ProductInputModel productModel, CancellationToken cancellationToken)
        {
            ...
            productModel.CompanyId = HttpContext.GetLoggedUserCompany();
        ...
        {
            return mapper.Map<IList<ProductOutputModel>>(await productRepository.GetProducts(HttpContext.GetLoggedUserCompany(), cancellationToken)); ;
        }
        ...
        {
            return mapper.Map<ProductOutputModel>(await productRepository.Get(e => e.Id.Equals(id) && e.Company.Id.Equals(HttpContext.GetLoggedUserCompany()), cancellationToken));
        }
